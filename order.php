...
<header class="header">
    ...
    <div class="header-1">
        <div class="navigation">
            <a href="admin.php" class="back"><i class="fa-solid fa-chevron-left"></i></a>
            <a href="ViewCustomers.php" class="next"><i class="fa-solid fa-chevron-right"></i></a>
        </div>
        <a href="" class="logo"><i class="fas fa-book"> books</i></a>
        <nav class="navbar">
